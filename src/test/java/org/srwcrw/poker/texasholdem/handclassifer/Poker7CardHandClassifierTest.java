...
@SpringBootTest(classes = {CardOrdinalFactory.class, CardFactoryImmutable.class, TestUtilsTexasHoldem.class, TestUtils.class, PackGenerator.class, TestUtils7Card.class, HandFactoryHand5.class, Hand5OrdinalFactoryFast.class})
